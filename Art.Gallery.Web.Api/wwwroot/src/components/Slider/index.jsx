    ...
    >
      ...
      <SwiperSlide>
        <div
          ...
          style={{
            ...
            backgroundImage: "url(src/assets/image/blog/16by9/big/01.jpg)",
            ...
            <div className="container px-3 my-auto">
              <div className="row">
                <div className="col-lg-7">
                  <Badge Text={"مگامنو"} className={"badge text-bg-danger mb-2"} LinkUrl={"#"} />
      ...
      <SwiperSlide>
        <div
          ...
          style={{
            backgroundColor: "red",
            backgroundImage: "url(src/assets/image/blog/16by9/big/02.jpg)",
            backgroundPosition: "center left",
            backgroundSize: "cover",
          }}
        >
          <div className="card-img-overlay rounded-0 d-flex align-items-center">
            <div className="container px-3 my-auto">
              <div className="row">
                <div className="col-lg-7">
                  <Badge Text={"گردشگری"} className={"badge text-bg-warning mb-2"} LinkUrl={"#"} />
                  <h2 className="text-white display-6">
                    <a
      ...
      <SwiperSlide>
        <div
          ...
          style={{
            ...
            backgroundImage: "url(src/assets/image/blog/16by9/big/03.jpg)",
            backgroundPosition: "center left",
            backgroundSize: "cover",
          }}
        >
          <div className="card-img-overlay rounded-0 d-flex align-items-center">
            <div className="container w-100 my-auto">
              <div className="row">
                <div className="col-lg-7">
                  <Badge Text={"کووید"} className={"badge bg-primary mb-2"} LinkUrl={"#"} />
                  <h2 className="text-white display-6">
                    <a
                      href="post-single-4.html"
                      className="btn-link text-reset fw-normal"

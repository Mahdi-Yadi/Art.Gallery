...
import PostBigCardItem from "../common/PostBigCardItem";

const TopHighlights = ({ Title, Description }) => {
  const CardItemsData = [
    {
      Title: "خرید و فروش ارز در کانال 37 هزار تومانی",
      CardImage: "/assets/images/blog/4by3/01.jpg",
    ...
    },
    {
      ...
      CardImage: "/assets/images/blog/4by3/02.jpg",
      Author: "مسعود راد",
    ...
    },
    {
      ...
      CardImage: "/assets/images/blog/4by3/03.jpg",
      Author: "مریم حسنی",
    ...
    },
    {
      ...
      CardImage: "/assets/images/blog/4by3/04.jpg",
      Author: "مهسا عظیمی",
          ...
          <div className="col">
            ...
            <div className="row gy-4">
              <div className="col-lg-7">
                ...
                CardImage={"/assets/images/blog/16by9/05.jpg"}
                Author={"ادمین"}
                AuthorAvatar={"/assets/images/avatar/01.jpg"}
                Date={"8 دی، 1400"}
                BadgeText={"پزشکی"}
